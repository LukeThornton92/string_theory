...
def product_detail(request, product_id):
    ...
    also produces a random filtered selection of other products you may like"""
    ...
    recommended_products = (
        ...
        # Filters through all products for ideal recommendations
        .order_by('?')
    )
...
def add_product(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(
                request,
                'Failed to add product, please ensure for is valid'
            )
    else:
        form = ProductForm()
...
def edit_product(request, product_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            messages.error(
                request,
                'Failed to edit product, please ensure for is valid'
            )
    else:
