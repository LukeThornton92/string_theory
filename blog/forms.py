...
class BlogPostForm(forms.ModelForm):
    tag_string = forms.CharField(
        ...
        label="Tags",
        help_text=(
            "Enter tags separated by commas (e.g., travel, food, technology)"
            ),
    ...
    def clean_tag_string(self):
        ...
        # Split by comma and capitalize the first letter of each tag.
        ...
        if not tag_list:
            raise forms.ValidationError(
                "Please enter at least one non-empty tag."
                )
        ...
        for tag_name in tag_list:
            ...
            # Add the tag to the list to be returned
